...
$slip_limit = 10;
$slip_offset = ($slip_page - 1) * $slip_limit;
...
LIMIT $slip_limit OFFSET $slip_offset
";
...
$slip_total_pages = ceil($slip_total / $slip_limit);
...
// Build borrowed equipment query - Show only LATEST borrow record for each equipment
$b_where = [];
$b_params = [];
    ...
    <div class="container">
        <div class="header">
            ...
            <div>
                ...
                <a href="inventory.php" class="btn" style="margin-left: 10px;">
                    🔙 Back to Inventory
                </a>
            </div>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-number"><?= count($slips) ?></div>
                <div class="stat-label">Active Slips</div>
            </div>
            <div class="stat-card">
                <div class="stat-number"><?= count($borrowed) ?></div>
        ...
        <div class="section">
            ...
            <?php if ($slip_total_pages > 1): ?>
                <div class="pagination">
                    <?php for ($i = 1; $i <= $slip_total_pages; $i++): ?>
                        <?php if ($i == $slip_page): ?>
                            <span class="current"><?= $i ?></span>
                        <?php else: ?>
                            <a href="?slip_page=<?= $i ?>"><?= $i ?></a>
                        <?php endif; ?>
                    <?php endfor; ?>
                </div>
            <?php endif; ?>
        ...
        <div class="section">
            ...
            <form method="get" class="filter-form">
                <!-- Preserve borrowed equipment filters -->
