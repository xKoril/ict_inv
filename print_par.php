...
// Get equipment list with all necessary fields for PAR
$equipment_sql = "SELECT e.equipment_type, e.brand, e.model, e.serial_number, e.locator,
                         ...
                         e.date_acquired, dt.custodian, dt.office_custodian
                  FROM equipment e
...
// Get the fund source from the first equipment
...
<head>
    ...
    <title>PAR Report - <?= htmlspecialchars($par_no) ?></title>
    <style>
        body {
        ...
        .equipment-table .prop-col { width: 15%; }
        .equipment-table .date-col { width: 12%; }
        .equipment-table .amount-col { width: 12%; }
...
<body>
    <div class="no-print print-buttons">
        <button onclick="window.print()">Print PAR</button>
